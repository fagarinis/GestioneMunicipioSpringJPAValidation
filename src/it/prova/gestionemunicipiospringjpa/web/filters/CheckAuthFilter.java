package it.prova.gestionemunicipiospringjpa.web.filters;
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (!isInWhiteList) {
			...
			if(isPathForOnlyAdministrators(pathAttuale) && !utenteInSession.isAdmin()) {
				httpRequest.setAttribute("messaggioUtenteNonAbilitato", "Non si è autorizzati alla navigazione richiesta");
